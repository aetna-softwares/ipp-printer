...
Printer.prototype.getJobs = function (attributes) {
  return this.jobs ;
}
...
Printer.prototype.attributes = function (filter, req) {
  ...
  var attrs = [
    ...
    { tag: C.NAME_WITH_LANG, name: 'printer-name', value: { lang: 'en-us', value: name } },
